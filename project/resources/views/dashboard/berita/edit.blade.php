...
@section('container')
    <div class="card-body">
        <div class="card card-primary"> <div class="card-header" style="margin-top: -4em;">
        ...
        <form method="POST" action="/dashboard/berita/{{ $berita->slug }}"      enctype="multipart/form-data">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="slug" name="slug" placeholder="Slug Berita" value="{{ old
                    ('slug', $berita->slug) }}"/>
                </div>
                ...
                <div class="form-group">
                    ...
                    <p style="margin-top: 10px; font-size: 90%; color: rgb(18, 138, 250);">
                        <i> Upload Foto jika ada perubahan.</i>
                    </p>
                    @error('foto')
                        <div class="invalid-feedback">
                            {{ $message }}
    ...
    <script>
        ...
        judul_berita.addEventListener('change', function(){ fetch('/dashboard/berita/checkSlug?judul_berita='+judul_berita.value)
        .then(respons => response.json())
        .then(data => slug.nilai = data.slug)
